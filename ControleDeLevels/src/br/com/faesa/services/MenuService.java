...
public class MenuService {
    ...
    private void exibirMenu() {
        ...
        System.out.println("3. Excluir Level");
        System.out.println("4. Consulta Geral (Todos os Arquivos)");
        System.out.println("5. Consulta Específica (Ver Levels de um Jogador)");
